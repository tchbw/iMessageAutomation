...
import { DBIMessageChatMessage, iMessageChatMessage } from '@main/types/imessage'
...
export function getContentFromIMessage(msg: InferSelectModel<typeof message>): string {
  if (msg.text !== null) {
    return msg.text
  }
...
export const iMessageMapper = {
  getMessageFromDbMessage: (dbMessage: DBIMessageChatMessage): iMessageChatMessage => {
    return {
      id: dbMessage.ROWID,
